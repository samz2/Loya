...
<head>
    ...
    <title>INTRANET SOLLERTIA</title>
    ...
    <div class="wrapper" id="app">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="/home" class="brand-link text-center">
				<span class="brand-text font-weight-light">SOLLERTIA</span>
			</a>
			<!-- Sidebar -->
			<div class="sidebar">
						...
						@switch(Auth::user()->tipo)
							...
							<li class="nav-item has-treeview">
								...
								<ul class="nav nav-treeview">
									...
									<li class="nav-item">
										<router-link to="/grado-cursos" class="nav-link">
		...
		<footer class="main-footer">
			...
			<strong>Copyright © {{$Anio}} <a href="https://wa.me/51977252147?text=hola%20necesito%20ayuda%20con%20el%20sistema" target="_blank">Sollertia College</a>.</strong> all rights reserved
		</footer>
    </div>
