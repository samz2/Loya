                        ...
                        <div class="content table-responsive table-full-width">
                            <v-client-table :data="alumnos" :columns="columns" :options="options">
                                <div slot="Acciones" slot-scope="props">
                                    <button class="btn btn-success altoBoton" data-toggle="tooltip" v-on:click="verPensiones(props.row.DNI,props.row.Nombre,props.row.apellidos)" data-placement="left" title="Pagar"><i class="fa fa-dollar" aria-hidden="true"></i></button>
                                </div>
                            </v-client-table>
                        </div>
	                </div>
